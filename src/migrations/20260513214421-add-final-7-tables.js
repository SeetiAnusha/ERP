  ...
  async up(queryInterface, Sequelize) {
    ...
    if (!existingTables.includes('credit_card_fees')) {
      ...
      await queryInterface.createTable('credit_card_fees', {
        ...
        expense_type: { type: Sequelize.STRING(50), allowNull: false, defaultValue: 'CARD_PROCESSING_FEE' },
        expense_category: { type: Sequelize.STRING(100), allowNull: false, defaultValue: 'Card Expenses' },
